...
REM  Usage: 
REM    isPopulateCMUpdate.bat <ORACLE/SQLSERVER> <Database> <user> <password
REM
...
ECHO @Scripts\oracle\isPopulatePortalMenuUpdateData.or.sql >> tempdata_%DB_NAME%.sql
...
SQLCMD -S %DB_SERVERNAME% -d %DB_NAME% -U %DB_USERNAME% -P %DB_PASSWORD% -b -i "C:\Program Files (x86)\Camstar\InSite Administration\Scripts\Sql Server\isPopulatePortalMenuUpdateData.sql"
...
ECHO -----------------------------------------------------------------------------
ECHO USAGE:
ECHO   "isReloadPortalMenu.bat <DB2|ORACLE|SQLSERVER> <Database Host> <Database Name> <User> <Password>"
ECHO Where
...
ECHO  Example :- "isReloadPortalMenu ORACLE PROD insiteadmin admin"
ECHO		 "isReloadPortalMenu SQLSERVER DBSERVERNAME PROD insiteadmin admin"
ECHO		 "isReloadPortalMenu SQLSERVER 10.10.10.10 PROD insiteadmin admin"
ECHO ------------------------------------------------------------------------------
