...
CREATE PROCEDURE createPortalMenuItem(
	...
	@Caption			nvarchar(50),
	@VirtualPageName	varchar(40),
	@PageFlowName       varchar(40),
	@SubMenuName		varchar(40),
...
BEGIN
	...
	PRINT('Creating OEE MenuItem into existent Resource Menu...')
	SELECT @MenuDefId = PortalMenuDefinitionId
	FROM PortalMenuDefinition
	WHERE PortalMenuDefinitionName = 'csiResource';
	
	EXEC createPortalMenuItem @MenuDefId, 7835, 110, 'LblMenuItemOEE', 'OEE', 'isOEEIndicator_VP', '', '' ;
	EXEC createPortalMenuItem @MenuDefId, 7835, 120, 'LblMenuItemOEEDetails', 'OEE Details', 'isOEEIndicatorDetails_VP', '', '' ;

	PRINT('Creating OEE MenuItem into existent Resource V8 Menu...')
	SELECT @MenuDefId = PortalMenuDefinitionId
	FROM PortalMenuDefinition
	...
	PRINT('Creating isMaterialQueues Menu...')
	EXEC createPortalMenuDefinition 'isMaterialQueues', 'Material Queues pages used in the Portal', @DefaultNotes, @MenuDefId OUTPUT
	EXEC createPortalMenuItem @MenuDefId, 7835, 0, 'isWeb_ManageInventory', 'Manage Inventory', 'isManageInventory_VP', '', ''
	EXEC createPortalMenuItem @MenuDefId, 7835, 10, 'isWeb_ManageMaterialQueue', 'Manage Material Queue', 'isLoadUnloadResourceQueue_VP', '', ''
	EXEC createPortalMenuItem @MenuDefId, 7835, 20, 'isWeb_ManageMaterialQueueSimple', 'Manage Material Queue Simple', 'isManageMaterialQueue_VP', '', ''
	EXEC createPortalMenuItem @MenuDefId, 7835, 30, 'isWeb_MaterialRequestAcknowledge', 'Material Request Acknowledge', 'isMaterialRequestAcknowledge_VP', '', ''
	EXEC createPortalMenuItem @MenuDefId, 7835, 40, 'isWeb_MaterialRequestStatusBoard', 'Material Request Status Board', 'isMaterialRequestStatusBoard_VP', '', ''
	EXEC createPortalMenuItem @MenuDefId, 7835, 50, 'isWeb_MaterialRequest', 'Material Request', 'isMaterialRequest_VP', '', ''
	

	PRINT('Creating Material Queues MenuItem into existent Portal Menu V8...')
	SELECT @MenuDefId = PortalMenuDefinitionId
	FROM PortalMenuDefinition
	WHERE PortalMenuDefinitionName = 'csiPortalMenuV8';

	EXEC createPortalMenuItem @MenuDefId, 7833, 100, 'isWeb_MaterialQueues', 'Material Queue', '', '', 'isMaterialQueues'

	PRINT('Creating Material Queues MenuItem into existent Portal Mobile Menu ...')
	SELECT @MenuDefId = PortalMenuDefinitionId
	FROM PortalMenuDefinition
	...
	PRINT('Creating Material Queues MenuItem into existent Portal Menu...')
	SELECT @MenuDefId = PortalMenuDefinitionId
	FROM PortalMenuDefinition
    ...
    EXEC csiRBACCreatePermission @RoleId, 'is Device Family Maint', 180, 3760, @PermissionModesFlag_NoSecAdmin
    EXEC csiRBACCreatePermission @RoleId, 'is Device Group Maint', 180, 7140, @PermissionModesFlag_NoSecAdmin
	EXEC csiRBACCreatePermission @RoleId, 'is Device Maint', 180, 7140, @PermissionModesFlag_NoSecAdmin
	EXEC csiRBACCreatePermission @RoleId, 'is Preactor Schedule Maint', 180, 7140, @PermissionModesFlag_NoSecAdmin
	EXEC csiRBACCreatePermission @RoleId, 'is Inventory Location Maint', 180, 7140, @PermissionModesFlag_NoSecAdmin
	EXEC csiRBACCreatePermission @RoleId, 'is Material Queue Maint', 180, 7140, @PermissionModesFlag_NoSecAdmin
	EXEC csiRBACCreatePermission @RoleId, 'is OEE Settings Maint', 180, 7140, @PermissionModesFlag_NoSecAdmin
	EXEC csiRBACCreatePermission @RoleId, 'is Auto Start Settings Maint', 180, 7140, @PermissionModesFlag_NoSecAdmin
	EXEC csiRBACCreatePermission @RoleId, 'is Defect Mapping Maint', 180, 7140, @PermissionModesFlag_NoSecAdmin
	EXEC csiRBACCreatePermission @RoleId, 'Image Maint', 180, 7140, @PermissionModesFlag_NoSecAdmin
	...
	EXEC csiRBACCreatePermission @RoleId, 'isERPRoute_VP', 110, 7755, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isOrderStatusMaint', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isInventoryLocation_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isManageInventoryLocation_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isMaterialQueue_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isManageMaterailQueue_InvDetailPopup_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isManageMaterialQueue_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isOEESettings_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isOEEIndicator_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isOEEIndicatorDetails_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isImageMaint_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isDefectMapping_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isAutoStartSettingsMaint_VP', 110, 8143, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'isScheduledOrderDetailsVP', 110, 8143, @PermissionModesFlag_None
	
	PRINT('Creating Default Inquiry Role')	
	select  @RoleId = RoleId from RoleDef where Rolename = 'Default Inquiry';
	SET @PermissionSQL = '140'
	EXEC csiRBACCreatePermissionsForQry  @RoleId, @PermissionSQL, @PermissionModesFlag_None;
	EXEC csiRBACCreatePermission  @RoleId, 'Resource OEE Inquiry', 140, 4841607, @PermissionModesFlag_None;
	
	PRINT('Creating "Default Mfg" Role...');
    select @RoleId = RoleId from RoleDef where Rolename = 'Default Mfg'
    SET @PermissionSQL = '100, 120, 130'
    EXEC csiRBACCreatePermissionsForQry @RoleId, @PermissionSQL, @PermissionModesFlag_None
	EXEC csiRBACCreatePermission @RoleId, 'Manage Inventory', 110, 3760, @PermissionModesFlag_ReadOnly
	EXEC csiRBACCreatePermission @RoleId, 'Remove Invnetory', 110, 3760, @PermissionModesFlag_ReadOnly
	EXEC csiRBACCreatePermission @RoleId, 'Transfer Inventory', 110, 3760, @PermissionModesFlag_ReadOnly
	EXEC csiRBACCreatePermission @RoleId, 'Load Material Queue', 110, 3760, @PermissionModesFlag_ReadOnly
	EXEC csiRBACCreatePermission @RoleId, 'Manage Material Queue', 110, 3760, @PermissionModesFlag_ReadOnly
	EXEC csiRBACCreatePermission @RoleId, 'Unload Material Queue', 110, 3760, @PermissionModesFlag_ReadOnly

	--Create Industry Defect Menu Item
	PRINT('Creating Industry Defect MenuItem into existent Container V8 Menu...')
	SELECT @MenuDefId = PortalMenuDefinitionId
	FROM PortalMenuDefinition
	WHERE PortalMenuDefinitionName = 'csiContainerV8';

	EXEC createPortalMenuItem @MenuDefId, 7835, 600, 'isLblMenuIndustryDefect', 'Industry Defect','isCurrentDefect_VP', '', '' 
		
	SELECT @RoleId = RoleId from RoleDef where Rolename = 'Default Pages'
	EXEC csiRBACAssignRole @RoleId, 'Default Portal Pages Role','CamstarAdmin', NULL, 0
	EXEC csiRBACCreatePermission @RoleId, 'isCurrentDefect_VP', 110, 8143, @PermissionModesFlag_None
