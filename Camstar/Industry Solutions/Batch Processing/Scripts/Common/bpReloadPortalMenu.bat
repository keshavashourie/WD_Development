...
REM  Usage: 
REM    bpPopulateCMUpdate.bat <ORACLE/SQLSERVER> <Database> <user> <password
REM
...
ECHO @Scripts\oracle\bpPopulatePortalMenuUpdateData.or.sql >> tempdata_%DB_NAME%.sql
...
SQLCMD -S %DB_SERVERNAME% -d %DB_NAME% -U %DB_USERNAME% -P %DB_PASSWORD% -b -i "C:\Program Files (x86)\Camstar\InSite Administration\Scripts\Sql Server\bpPopulatePortalMenuUpdateData.sql"
...
ECHO -----------------------------------------------------------------------------
ECHO USAGE:
ECHO   "bpReloadPortalMenu.bat <DB2|ORACLE|SQLSERVER> <Database Host> <Database Name> <User> <Password>"
ECHO Where
...
ECHO  Example :- "bpReloadPortalMenu ORACLE PROD insiteadmin admin"
ECHO		 "bpReloadPortalMenu SQLSERVER DBSERVERNAME PROD insiteadmin admin"
ECHO		 "bpReloadPortalMenu SQLSERVER 10.10.10.10 PROD insiteadmin admin"
ECHO ------------------------------------------------------------------------------
