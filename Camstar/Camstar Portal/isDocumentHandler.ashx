...
<%@ WebHandler Language="C#" Class="isDocumentHandler" %>
...
/// </summary>
public partial class isDocumentHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    #region Statics
    ...
    {
        //const string ProcedureName = "HandleRequest";
        try
        {
