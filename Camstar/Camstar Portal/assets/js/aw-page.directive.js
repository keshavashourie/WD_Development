 ...
 * mode.
 *
 * @module js/aw-page.directive
 */
import app from 'app';
import eventBus from 'js/eventBus';
import 'js/configurationService';
import 'js/appCtxService';
import 'js/aw-header.directive';
 ...
 */
app.directive( 'awPage', [
    'configurationService',
    'appCtxService',
    'narrowModeService',
    function( cfgSvc, appCtxSvc, narrowModeSvc ) {
        return {
            restrict: 'E',
            ...
            templateUrl: app.getBaseUrlPath() + '/html/aw-page.directive.html'
        };
    }
] );
