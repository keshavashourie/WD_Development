...
{
    public class SS_SetupBModelingBase : MatrixWebPart
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!_chkExistingInstance.IsChecked)
            {
        ...
        private void _SetupB_FetchSelection(string FetchType)
        {
            ...
            // set the WorkflowNavigator selection data 
            // the reason we do this AFTER setting everything else is because doing a direct setValue to the oServiceData
            // will cause the other data in the oObjectChanges to get cleared out
