...
/// <summary>
/// Summary description for SS_PDALimitsMaint
/// </summary>

namespace Camstar.WebPortal.WebPortlets.Shopfloor
{
    public class SS_PDALimitsMaint : SS_SetupBModelingBase
    {
        ...
        protected CWC.NamedObject _ndoSelectionWorkCenter { get { return Page.FindCamstarControl("Selection_WorkCenter") as CWC.NamedObject; } }
        ...
        protected CWC.NamedObject _ndoWorkCenter { get { return Page.FindCamstarControl("ObjectChanges_WorkCenter") as CWC.NamedObject; } }
        
        protected JQDataGrid _gridBins { get { return Page.FindCamstarControl("ObjectChanges_Bins") as JQDataGrid; } }
        protected JQDataGrid _gridLossReasons { get { return Page.FindCamstarControl("ObjectChanges_LossReasons") as JQDataGrid; } }
        protected JQDataGrid _gridUpperLimits { get { return Page.FindCamstarControl("ObjectChanges_UpperLimits") as JQDataGrid; } }
        protected JQDataGrid _gridSmallLotLimits { get { return Page.FindCamstarControl("ObjectChanges_SmallLotLimits") as JQDataGrid; } }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            _SelectionControls.Add(_ndoSelectionWorkCenter);
            ...
            _CriteriaControls.Add(_ndoWorkCenter);

            // add any subentity grid controls to the control collection
            _SubentityGridControls.Add(_gridBins);
            _SubentityGridControls.Add(_gridLossReasons);
            _SubentityGridControls.Add(_gridUpperLimits);
            _SubentityGridControls.Add(_gridSmallLotLimits);
