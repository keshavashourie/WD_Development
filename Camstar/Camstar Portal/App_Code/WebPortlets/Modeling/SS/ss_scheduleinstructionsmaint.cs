...
/// <summary>
/// Summary description for SS_ScheduleInstructionsMaint
/// </summary>

namespace Camstar.WebPortal.WebPortlets.Shopfloor
{
    public class SS_ScheduleInstructionsMaint : SS_SetupBModelingBase
    {
        ...
        protected CWC.TextBox _txtInstructions { get { return Page.FindCamstarControl("ObjectChanges_Instructions") as CWC.TextBox; } }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            _CriteriaControls.Add(_txtInstructions);
           ...
           // _DetailControl.Add(_txtInstructions);
            ...
            _HiddenGridColumns.Add("Instructions");
        }
    }
}
