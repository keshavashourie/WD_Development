...
{
    public class PanelFilters : MatrixWebPart
    {
        #region Events
        ...
        protected virtual void SetSecondaryFilters(bool isVisible)
        {
            ...
            SecondaryFilter.Visible =
            AvailabilityFilter.Visible =
            EmployeeFilter.Visible =
            ResourceStatusCodeFilter.Visible =
            ResourceStatusReasonFilter.Visible = isVisible;
