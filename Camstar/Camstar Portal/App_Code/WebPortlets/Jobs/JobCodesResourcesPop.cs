...
/// <summary>
/// Job Codes Resources Popup
/// </summary>

namespace Camstar.WebPortal.WebPortlets.Jobs
{
	public class JobCodesResourcesPop : MatrixWebPart
	{
		#region Property
		...
		protected override void OnInit(EventArgs e)
		{
			...
			if (Page.PortalContext.DataContract != null && Page.PortalContext.DataContract.GetValueByName("DCMWP_ServiceType") != null)
		...
		{                     
            ...
            qUtil.ExecuteSQL(Sql, new QueryOptions(), ref data, ref status);
            DataTable dt = data.GetAsDataTable();
			_chartJobCodes.Data = dt;
		}
