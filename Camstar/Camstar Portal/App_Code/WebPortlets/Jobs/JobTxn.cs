...
/// <summary>
/// Summary description for JobTxn
...
{
    public class JobTxn : MatrixWebPart
    {
        #region Property
        ...
        protected CWC.NamedObject _ndoStageDocumentTxt { get { return Page.FindCamstarControl("JobModelDocumentSet") as CWC.NamedObject; } }
        protected CWC.NamedObject _ndoToStageDocumentTxt { get { return Page.FindCamstarControl("JobDocSetToStage") as CWC.NamedObject; } }
        ...
        //
        // Contructor JobTxn, set default value 
        //
        public JobTxn()
        {
            // set default value
        ...
        public override void WebPartCustomAction(object sender, Personalization.CustomActionEventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "AdjustSimpleJobMargin", "$(function(){$('#ctl00_WebPartManager_JobResource_WP_Job_IsSimpleMode').css('margin-left','-300px');});", true);
                Page.ShopfloorReset(sender, e);
                if (_docStageDocument != null)
                    _docStageDocument.Visible = false;
                if (_sectStageDoc != null)
                    _sectStageDoc.Visible = false;
            }
        ...
        protected virtual void SetGeneralFields(Result rslt)
        {
            ...
            {
                var webpartResource = (MatrixWebPart)Page.CamstarControls.Where(r => r.ID == "JobResource_WP").FirstOrDefault();
            ...
            if ((PrimaryServiceType == TransactionMode.JobComplete.ToString() || PrimaryServiceType == TransactionMode.JobCancel.ToString()) && (_gridMaintenanceStatus.Data as MaintenanceStatus[]).Count() > 0)
            ...
            if (((rslt as ICreator).GetValue("Value.JobModelDetailDocumentSet") as NamedObjectRef) != null)
            {
                ...
                _ndoStageDocumentTxt.Data = ((rslt as ICreator).GetValue("Value.JobModelDetailDocumentSet") as NamedObjectRef).Name;
            }

            if (_chkIsSimpleMode != null)
            {
                if (_ndoJobModelDocumentTxt.Data != null && !String.IsNullOrEmpty(_ndoJobModelDocumentTxt.Data.ToString()) && _ndoResource.Data != null)
                {
                    _chkIsSimpleMode.Margin.Left = -330;
                }
                else
                {
                    _chkIsSimpleMode.Margin.Left = -300;
                }
        ...
        public void ViewDocumentRefresh(string paramDocumentSet, ESDocumentType docType)
        {
            ...
            ctrViewDocument.OpenDocument = true;
            // Get document Data
