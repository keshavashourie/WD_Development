...
{
    public class PartRequestCancelAcknowledge : MatrixWebPart, IPostBackEventHandler
    {
        ...
        public PartRequestCancelAcknowledge()
        {
            //
        ...
        {
            if (this.PrimaryServiceType == "PartRequestCancelAcknowledge")
            {
        ...
        public void ResourceField_DataChanged(object sender, EventArgs e)
        {
            ...
            PartRequestCancelAcknowledgeService Svc = new PartRequestCancelAcknowledgeService(fs.CurrentUserProfile);
            OM.PartRequestCancelAcknowledge SvcData = new OM.PartRequestCancelAcknowledge();
            PartRequestCancelAcknowledge_Info SvcInfo = new PartRequestCancelAcknowledge_Info();
            PartRequestCancelAcknowledge_Request ReqData = new PartRequestCancelAcknowledge_Request();
            PartRequestCancelAcknowledge_Result ResData = new PartRequestCancelAcknowledge_Result();
        ...
        public override void GetInputData(OM.Service serviceData)
        {
            ...
            if (this.PrimaryServiceType == "PartRequestCancelAcknowledge")
            {
                ...
                if (getGrid.Count() > 0)
                {
                    if (serviceData is OM.PartRequestCancelAcknowledge)
                    {
