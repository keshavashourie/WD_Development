...
{
    public class SS_PartRequestAcknowledge : PartRequestAcknowledge
    {
        //Controls declaration
        protected DataEnvelopControl _envPartRequestAcknowledge { get { return Page.FindCamstarControl("PartRequest_Envelope") as DataEnvelopControl; } }
        ...
        public void DisplayAlerts(ResultStatus status, out string CompletionMessage)
        {
            ...
            if (status.IsSuccess)
            {
                ...
                if (bAlertMsg)
                {
                    ...
                    _envPartRequestAcknowledge.SS_DataPacket = oData;
        ...
        public virtual void PopupWIPMessages(bool EndResponse = false)
        {
            ...
            objLinks[0].SourceMember = "PartRequestAcknowledge_Envelope";
