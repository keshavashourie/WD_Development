...
{
    public class scsContainerSearchVP_R2 : MatrixWebPart
    {
        public scsContainerSearchVP_R2()
        {
        }
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            Current_ReworkReason.TextEditControl.Attributes.Add("onchange", "ContainerSearchVPR2_SetDefaultDDLValue('" + Current_InRework.TextEditControl.ClientID + "', '" + Current_InRework.ClientID + "', 'True', '1','" + Current_ReworkReason.TextEditControl.ClientID + "')");
            Current_OnHoldReason.TextEditControl.Attributes.Add("onchange", "ContainerSearchVPR2_SetDefaultDDLValue('" + Current_OnHold.TextEditControl.ClientID + "', '" + Current_OnHold.ClientID + "', 'True', '1','" + Current_OnHoldReason.TextEditControl.ClientID + "')");
