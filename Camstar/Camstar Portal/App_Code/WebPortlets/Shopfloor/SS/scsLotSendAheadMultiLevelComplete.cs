...
/// <summary>
/// Summary description for scsLotSendAheadMultiLevelComplete
/// </summary>

namespace Camstar.WebPortal.WebPortlets.Shopfloor
{
    public class scsLotSendAheadMultiLevelComplete : scsShopfloorBase
    {
        protected CWC.TextBox _txtSelectionId { get { return Page.FindCamstarControl("scsLotSendAheadMultiLevel_SelectionId") as CWC.TextBox; } }
        protected CWC.TextBox _txtComputerName { get { return Page.FindCamstarControl("scsLotSendAheadMultiLevel_ComputerName") as CWC.TextBox; } }
        protected CWC.TextBox _txtSendAheadLot { get { return Page.FindCamstarControl("scsLotSendAheadMultiLevel_SendAheadLot") as CWC.TextBox; } }
        protected CWC.TextBox _txtParentLot { get { return Page.FindCamstarControl("scsLotSendAheadMultiLevel_ParentLot") as CWC.TextBox; } }
        protected CWC.TextBox _txtServiceName { get { return Page.FindCamstarControl("scsLotSendAheadMultiLevel_ServiceName") as CWC.TextBox; } }
        protected JQDataGrid _gridContainer { get { return Page.FindCamstarControl("scsLotSendAheadMultiLevel_ContainerGrid") as JQDataGrid; } }
        ...
        private void FetchData(string sEventType, string sContainerName = "")
        {
            ...
            if (oResultStatus.IsSuccess)
            {
                ...
                if (sEventType == "SelectionId")
                {
                    ...
                    {
                        JQDataGrid _gridContainerTemp = Page.FindCamstarControl("scsLotSendAheadMultiLevel_ContainerGrid") as JQDataGrid;
                        ...
                        RequestSendAheadDetails(sResolvedContainer);
                    }
        ...
        //
        //---------------------------------------------------
        private void RequestSendAheadDetails(string sContainerName)
        {
            // Prepare service
            var fs = FrameworkManagerUtil.GetFrameworkSession();
            ResultStatus oServiceResult = new ResultStatus(null, false);
            ...
            (oServiceData as OM.scsLotSendAheadMultiLevel).Container = new ContainerRef(sContainerName);
            oServiceInfo.ParentName = new Info(true);
            oServiceInfo.SendAheadName = new Info(true);
            ...
            if (oResultStatus.IsSuccess)
            {
                if ((oResult.Value as OM.scsLotSendAheadMultiLevel).ParentName != null)
                    _txtParentLot.Data = (oResult.Value as OM.scsLotSendAheadMultiLevel).ParentName;
                if ((oResult.Value as OM.scsLotSendAheadMultiLevel).SendAheadName != null)
                    _txtSendAheadLot.Data = (oResult.Value as OM.scsLotSendAheadMultiLevel).SendAheadName;
            }
        }
        ...
        private void CustomReset()
        {
            ...
            _txtParentLot.ClearData();
            _txtSendAheadLot.ClearData();
            _txtSelectionId.Focus();
        } // CustomReset
        ...
        public ResultStatus CustomSubmit()
        {
            ...
            (oServiceData as OM.scsLotSendAheadMultiLevel).IsSendAheadComplete = true;

            if (_txtParentLot.Data != null)
                (oServiceData as OM.scsLotSendAheadMultiLevel).Container = new ContainerRef(_txtParentLot.Data.ToString());
