...
/// <summary>
/// Summary description for SS_StopMaxTimeWindow
/// </summary>
namespace Camstar.WebPortal.WebPortlets.Shopfloor
{
    public class SS_StopMaxTimeWindow : scsShopfloorBase
    {
        #region Properties
        ...
        #region Page Events
            ...
            public void SelectionIdField_DataChanged()
            {
                try
                {
                    if (_txtSelectionId.Data != null)
                    {
                        ...
                        StopMaxTimeWindowService objSvc = new StopMaxTimeWindowService(fs.CurrentUserProfile);
                        StopMaxTimeWindow objSvcData = new StopMaxTimeWindow { SelectionId = (string)_txtSelectionId.Data };
                        StopMaxTimeWindow_Info objSvcInfo = new StopMaxTimeWindow_Info { Containers = FieldInfoUtil.RequestValue() };

                        // init the result object
                        StopMaxTimeWindow_Result objResult = new StopMaxTimeWindow_Result();

                        // execute to request the value
                        ResultStatus resultStatus = objSvc.ResolveSelectionId(objSvcData, new StopMaxTimeWindow_Request { Info = objSvcInfo }, out objResult);
                        ...
                        if (resultStatus.IsSuccess)
                        {
                            ...
                            foreach (OM.ContainerRef oContainer in objResult.Value.Containers)
                            {
                                ...
                                {
                                    SEMI.AppCode.UIUtility.GetLotQuerySelection(this, "StopMaxTimeWindow", oContainer.Name.ToString(), false, ref _gridContainers, "ContainersField",true);
                                }
                            }
                        }
                        else
            ...
            public override void GetInputData(Service serviceData)
            {
                ...
                {
                    OM.StopMaxTimeWindow svcData = serviceData as OM.StopMaxTimeWindow;
                ...
                if (Page.IsPostBack)
                    ...
                    if (SEMI.AppCode.UIUtility.IsPopupClose(this))
                    {
                        if (_envSelectedLots != null)
                            ...
                            if (Page.DataContract.GetValueByName("StopMaxTimeWindow_SelectedLotsListDM") != null)
                                _envSelectedLots.SS_ContainersList = Page.DataContract.GetValueByName("StopMaxTimeWindow_SelectedLotsListDM") as string[];
                        ...
                        if (_envSelectedLots.SS_ContainersList != null)
                        {
                            ...
                            foreach (string sContainersItem in sContainers)
                            {
                                ...
                                if (string.IsNullOrEmpty(strSelectedGridId))
                                {
                                    SEMI.AppCode.UIUtility.GetLotQuerySelection(this, "StopMaxTimeWindow", sContainersItem, false, ref _gridContainers, "ContainersField",true);
                                }
                            }
