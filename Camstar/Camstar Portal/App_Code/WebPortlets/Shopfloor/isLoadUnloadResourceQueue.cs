...
{
    public class isLoadUnloadResourceQueue : MatrixWebPart
    {
        #region Properties
        ...
        protected virtual CWC.RevisionedObject BOM
        {
            get
            {
                return Page.FindCamstarControl("isManageMaterialQueue_isBOM") as CWC.RevisionedObject;
            }
        }

        protected virtual CWC.RevisionedObject ERPBOM
        {
            get
            {
                return Page.FindCamstarControl("isManageMaterialQueue_isERPBOM") as CWC.RevisionedObject;
            }
        }
        ...
        protected virtual JQDataGrid _gridismaterialreqDetails
        {
            get
            {
                return Page.FindCamstarControl("isManageMaterialQueue_isMaterialRequirements") as JQDataGrid;
            }
        }
        ...
        protected virtual JQDataGrid _gridisMaterialQueueReplenishDetails
        {
            get
            {
                return Page.FindCamstarControl("isLoadUnloadMatReplenishmentDtlsGrid") as JQDataGrid;
            }
        }
        ...
        protected override void OnLoad(System.EventArgs e)
        {
            ...
            Resource.DataChanged += KitResource_DataChanged;
            ...
            _gridismaterialreqDetails.RowSelected += _gridismaterialreqDetails_RowSelected;
            DummyProduct.DataChanged += DummyProduct_DataChanged;
        ...
        void Qty_DataChanged(object sender, EventArgs e)
        {
            ...
            {
                double actualqty = double.Parse(QtyToValidate.Data.ToString());
                double inputqty = double.Parse(Qty.Data.ToString());
        ...
        void DummyProduct_DataChanged(object sender, EventArgs e)
        {
        ...
        ResponseData _gridismaterialreqDetails_RowSelected(object sender, JQGridEventArgs args)
        {
            if (_gridismaterialreqDetails.GridContext.SelectedItem as OM.isMaterialRequirementService != null)
            {
                var GridProduct = (_gridismaterialreqDetails.GridContext.SelectedItem as OM.isMaterialRequirementService).Product;
                DummyProduct.Data = GridProduct;
            }
            else
                DummyProduct.Data = null;
        ...
        void Product_DataChanged(object sender, EventArgs e)
        {
            ...
            if (ERPBOM.Data != null)
            {
                ...
                RouteStep.Visible = true;
                Spec.Visible = false;
                MfgOrder.Enabled = false;
                Product.Enabled = true;
            }

            if (ERPBOM.Data == null && BOM.Data == null)
            {
                Spec.Visible = false;
                RouteStep.Visible = false;
        ...
        void RouteStep_DataChanged(object sender, EventArgs e)
        {
            ...
            RouteStep.Visible = true;
            if (Product.Data != null && ERPBOM.Data == null)
            {
                RouteStep.Visible = false;
            }
        ...
        void ReloadMaterialRequirements()
        {
            ...
            if (Product.Data != null)
            {
                ...
                serviceinfo.isBOM = FieldInfoUtil.RequestValue();
                serviceinfo.isERPBOM = FieldInfoUtil.RequestValue();
                MfgOrder.Enabled = false;
            }
            else
            {
            ...
            if (oResultStatus.IsSuccess)
            {
                _gridismaterialreqDetails.ClearData();
                if (result.Value.isMaterialRequirements != null)
                {

                    Array oMatreqArray = result.Value.isMaterialRequirements.ToArray();

                    (_gridismaterialreqDetails.GridContext as BoundContext).Data = oMatreqArray;

                    _gridismaterialreqDetails.BoundContext.LoadData();
                    CamstarWebControl.SetRenderToClient(_gridismaterialreqDetails);
                }
                if (result.Value.isERPRoute != null)
                {
                    isERPRoute.Data = result.Value.isERPRoute.ToString();
                }
                else
                {
                    isERPRoute.Data = null;
                }

                if (result.Value.isBOM != null)
                    BOM.Data = result.Value.isBOM;
                else
                    BOM.Data = null;

                if (result.Value.isERPBOM != null)
                    ERPBOM.Data = result.Value.isERPBOM;
                else
                    ERPBOM.Data = null;
        ...
        protected virtual OM.ResultStatus SortingMaterialQueue()
        {
            ...
            if (_gridisMaterialQueueDetails.Data != null)
            {
                ...
                return new OM.ResultStatus("Grid detail is empty.", false);
        }
        ...
        {
            if (ContainerOrLot.Data != null) return;
            QtyToValidate.ClearData();
            Qty.ClearData();
