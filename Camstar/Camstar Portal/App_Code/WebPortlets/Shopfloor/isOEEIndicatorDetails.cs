...
{
    public class isOEEIndicatorDetails : MatrixWebPart
    {
        public isOEEIndicatorDetails() { }
        ...
        protected override IEnumerable<ScriptReference> GetScriptReferences()
        {
            ...
            yield return new ScriptReference("~/Scripts/user/Industry Solutions/BarChartTable.js");
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //Page.Header.Controls.Add(new LiteralControl("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + ResolveUrl("~/Themes/User/Industry Solutions/BarChartTable.css") + "\" />"));
