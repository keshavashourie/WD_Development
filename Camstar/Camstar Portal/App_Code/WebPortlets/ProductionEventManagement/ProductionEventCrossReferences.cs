...
{
    public class ProductionEventCrossReferences : MatrixWebPart
    {
        ...
        {
            ClearValues(CreateServiceData("QualityObjectInquiry"));
            ClearValues(CreateServiceData("UpdateEvent"));
        }
        ...
        public virtual void OpenFloatPEManageFromSearch()
        {
            ...
            var managePageToOpen = selectedEventType.Equals("Nonconformance") ? "ProductionEventManage_VP" : "GenericEventManage_VP";
        ...
        public virtual void OpenFloatPEManageFromXRefs()
        {
