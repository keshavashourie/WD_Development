...
/*jshint -W083 */
	...
	$.jstree.core.prototype = {
		...
		is_parent : function (obj) {
            ...
            //allows nodes with false leaf attribute to be recognised as "parent" nodes, so rest of jstree logic can move on
            //child nodes are loaded in pickListPanel.js and appended via jstree.create_node()

            var result = !(obj && (obj.state.loaded === false || obj.children.length > 0)) ?
                (obj.li_attr.leaf != undefined && (obj.li_attr.leaf === false)) : true;
