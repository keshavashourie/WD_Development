...
(function ($, undefined) {
    ...
    $.widget("evol.colorpicker", {
                ...
                case 'INPUT':
                    ...
                    if (inline == true) {
                        e.addClass('colorPicker ' + this._id)
                            .wrap('<div style="width:' + (this.element.width() + 42) +
                            'px; display:inline-block; margin-top:4px;"></div>');
                    } else {
                        e.addClass('colorPicker ' + this._id)
                            .wrap('<div style="width:' + (this.element.width() + 42) + 'px;"></div>');
                    }
                    e.addClass('colorPicker ' + this._id)
        ...
        _paletteHTML: function () {
            ...
            h.push('<div class="evo-pop', _ie, ' ui-widget-colorpicker ui-widget-content-colorpicker ui-corner-all-colorpicker"',
                this._isPopup ? ' style="position:inherit"' : '', '>');
            // palette
        ...
        _paletteHTML1: function () {
            var h = [], labels = this.options.strings.split(','),
                ...
                oTRTH = '<tr><th colspan="10" class="ui-widget-content-colorpicker">';
            // base theme colors
        ...
        _switchPalette: function (link) {
            if (this._enabled) {
                ...
                if ($(link).hasClass('evo-hist')) {
                    // history
                    var h = ['<table class="evo-palette"><tr><th class="ui-widget-content-colorpicker">',
