		...
		return this.each(function(){
			...
			if (editable === "0" && !$(ind).hasClass("not-editable-row")) {
				...
				if(cnt > 0) {
                    ...
                    $(ind).attr("editable","1");
                    //setTimeout(function () { $("td:eq(" + focus + ") input", ind).focus();}, 0); //Bug 70052 last column, once you select the cell in the grid the horizontal scrolling slides back over to the left and you can’t select the values.
					if(o.keys===true) {
		...
		if (editable==="1") {
			...
			if (o.url === 'clientArray') {
				...
				$.ajax($.extend({
                    ...
                    type: o.mtype,
                    //additionally pass 'headers' to prevent further changes in 'data' in jQuery
                    //info about fix and connected issue - https://github.com/jquery/jquery/pull/4650
