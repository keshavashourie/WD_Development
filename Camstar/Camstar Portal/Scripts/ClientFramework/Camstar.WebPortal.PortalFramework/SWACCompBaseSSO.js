                        ...
                        case 'LOAD_CONFIRMLOGOUT':
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    var url = loc.protocol + "//" + loc.hostname + "/IDPAgent/api/v1/sso-service-provider/logout-request?state=" + SSOSessionId;
                                    executeWhenTrue = "KillSession(true);setTimeout( function()  {top.location.href = '" + url + "';}, 2000 );";

                                },
                                error: function (error) {
                                    console.error('Error getting SAML SessionId:', result.error);
                                }
