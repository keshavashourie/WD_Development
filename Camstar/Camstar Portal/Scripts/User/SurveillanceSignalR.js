...
function ConnectToHubScript(ServerURL, correlationId, SurvCIOChannelAdapter) {
    ...
    var resultGrid = jQuery('#ctl00_WebPartManager_SS_WIPSignalRSurv_ResultWP_SurveillanceStatusDetails');
...
function showMessage(messageText) {
    var d = $.Deferred();
    $("#ctl00_WebPartManager_SS_WIPSignalRSurv_SearchWP_SubscriptionStatus_ctl00").val(messageText);
}

function filterGrid() {
    var FilterCriteria = document.getElementById('ctl00_WebPartManager_SS_WIPSignalRSurv_SearchWP_FilterCriteria_Edit').value;
    var Status = document.getElementById('ctl00_WebPartManager_SS_WIPSignalRSurv_SearchWP_SubscriptionStatus_ctl00').value;
    var RowCount = 0;

    if (Status != "") {
        if (FilterCriteria == "Resource")
            var selectedCriteriaValue = document.getElementById('ctl00_WebPartManager_SS_WIPSignalRSurv_SearchWP_ss_GetSurveillanceStatuses_ss_Resource_Edit').value;
        else if (FilterCriteria == "Resource Group")
            var selectedCriteriaValue = document.getElementById('ctl00_WebPartManager_SS_WIPSignalRSurv_SearchWP_ss_GetSurveillanceStatuses_ss_ResourceGroup_Edit').value;
        else if (FilterCriteria == "Operation")
            var selectedCriteriaValue = document.getElementById('ctl00_WebPartManager_SS_WIPSignalRSurv_SearchWP_ss_GetSurveillanceStatuses_ss_Operation_Edit').value;
        else if (FilterCriteria == "Work Center")
            var selectedCriteriaValue = document.getElementById('ctl00_WebPartManager_SS_WIPSignalRSurv_SearchWP_ss_GetSurveillanceStatuses_ss_WorkCenter_Edit').value;
...
function clearAllBtnClick() {
    document.getElementById('ctl00_WebPartManager_SS_WIPSignalRSurv_SearchWP_FilterCriteria_Edit').value = "";
    filterGrid();
}