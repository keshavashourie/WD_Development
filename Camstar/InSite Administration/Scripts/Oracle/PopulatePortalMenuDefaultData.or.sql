...
BEGIN
  ...
  createPortalMenuDefinition('csiContainer', 'Container transactions used in the Portal', vDefaultNotes, vMenuDefId);
	...
	createPortalMenuItem('4006998c-1e19-4812-9244-62701fe8876c',vMenuDefId, 7835, 121, 'Component Replace', 'CSICDOName_ComponentReplace','ComponentReplaceVP', '', '');
	...
	createPortalMenuItem('ed8a737f-b261-493a-bf3a-e9ff1545c93c',vMenuDefId, 7835, 124, 'Container Attribute Maintenance', 'LblMenuContAttrMaint','ContainerAttrMaintVP', '', '');
	createPortalMenuItem('b5a2daf4-4f8e-4688-b634-3f317c1c99aa',vMenuDefId, 7835, 125, 'Container Maintenance', 'LblMenuContMaint','ContainerMaintenanceVP', '', '');
	...
	createPortalMenuItem ('fa645aa7-c7d8-4176-9854-33b087cee863',vMenuDefId, 7835, 122, 'Container Attribute Maintenance', 'LblMenuContAttrMaint','ContainerAttrMaintVP', '', ''); 
	createPortalMenuItem ('b973940f-b162-4fe2-af15-fb84fd1a38be',vMenuDefId, 7835, 123, 'Container Maintenance', 'LblMenuContMaint','ContainerMaintenanceVP', '', '');
	createPortalMenuItem ('b5a2daf4-4f8e-4688-b634-3f317c1c99ac',vMenuDefId, 7835, 124, 'Container Rename', 'CSICDOName_ContainerRename','RenameVP', '', '');
	createPortalMenuItem ('b5a2daf4-4f8e-4688-b634-3f317c1c11qr',vMenuDefId, 7835, 125, 'Container Rename (Multiple)', 'LblMenuRenameMulti','MultiContainerRenameVP', '', '');
	...
	createPortalMenuItem ('060ef436-8984-4351-ab9b-8d810ce1ddd0',vMenuDefId, 7835, 30, 'Job Acknowledge', 'CSICDOName_JobAcknowledge','JobAcknowledge_VP', '', '');
	...
	createPortalMenuItem ('8eef661b-dd34-411d-9a63-d98303358893',vMenuDefId, 7835, 20, 'SPC Realtime Monitoring', 'LblSPCRealtimeMonitoring','SPCRealtimeMonitoring_VP', '', '' );
