...
ECHO @..\Scripts\oracle\PopulatePortalMenuUpdatedata.or.sql >> tempdata_%DB_NAME%.sql
...
SQLCMD -S %DB_SERVERNAME% -d %DB_NAME% -U %DB_USERNAME% -P %DB_PASSWORD% -b -i "..\Scripts\Sql Server\PopulatePortalMenuUpdatedata.sql"
IF ERRORLEVEL 1 set errorstatus=99
GOTO EXIT
:END
...
ECHO -----------------------------------------------------------------------------
ECHO USAGE:
ECHO   "csiPopulateCMMenu.bat <DB2|ORACLE|SQLSERVER> <Database Host> <Database Name> <User> <Password>"
ECHO Where
...
ECHO  Example :- "csiPopulateCMMenu ORACLE PROD insiteadmin admin"
ECHO		 "csiPopulateCMMenu SQLSERVER DBSERVERNAME PROD insiteadmin admin"
ECHO		 "csiPopulateCMMenu SQLSERVER 10.10.10.10 PROD insiteadmin admin"
ECHO ------------------------------------------------------------------------------
