IF NOT EXISTS (SELECT name FROM sysobjects WHERE name = 'DPT_IV_EventPurge' AND type = 'V')
    EXECUTE sp_executesql N'CREATE VIEW DPT_IV_EventPurge AS SELECT 1 AS dummy';
GO
ALTER VIEW DPT_IV_EventPurge 
AS
--===========================================================================
-- Author      : Benny Chia
...
(   SELECT TOP 50
	...
	WHERE 
		evt.CloseDate IS NOT NULL AND evt.EventId IN (':vInstanceValue')
